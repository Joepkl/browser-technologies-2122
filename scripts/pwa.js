...
//Checken of er al wat staat in de session storage.  ->  Zo ja is dat de value van pwaDocent variabele
if(sessionStorage.getItem('pwa-docent')) {
    pwaDocent.value = sessionStorage.getItem('pwa-docent');
}

// Wanneer de variabele verandert  -> functie gaat af waarmee de value wordt aangepast in de session storage
